...
## Todo: NightTime  
 ...
 ## Implement the Clr.cs instead of Display
 ...
 ## Add a status bar to the top of the screen, showing the player's health, mana, and other stats. This will help the player keep track of their character's status and make informed decisions during gameplay.
